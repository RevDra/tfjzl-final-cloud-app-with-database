# Generated by Django 5.2.12 on 2026-03-18 02:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='course',
            name='users',
            field=models.ManyToManyField(through='pages.Enrollment', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Instructor',
            fields=[
        ...
        migrations.AddField(
            model_name='course',
            name='instructors',
            field=models.ManyToManyField(to='pages.instructor'),
        ),
        migrations.CreateModel(
            name='Learner',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('choices', models.ManyToManyField(to='pages.choice')),
                ('enrollment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pages.enrollment')),
            ],
        ),
    ]
